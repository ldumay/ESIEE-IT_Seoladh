...
public class ViewCampagne extends JEditorPane{
	...
	private void initialize() {
		...
		gl_panMessage.setVerticalGroup(
			gl_panMessage.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panMessage.createSequentialGroup()
					.addGap(6)
					.addComponent(panelMessage, GroupLayout.DEFAULT_SIZE, 402, Short.MAX_VALUE)
					.addContainerGap())
		);
		...
		System.out.println(ekit.getContentPane().getComponent(0).getName());
		...
		System.out.println(ekit.getDocumentCore());
